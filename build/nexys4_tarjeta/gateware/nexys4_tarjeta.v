//--------------------------------------------------------------------------------
// Auto-generated by Migen (7014bdc) & LiteX (d0c41990) on 2021-03-23 13:29:39
//--------------------------------------------------------------------------------
module nexys4_tarjeta(
...
assign builder_csr_bankarray_csrbank0_reset0_w = main_soccontroller_reset_storage;
assign builder_csr_bankarray_csrbank0_scratch0_w = main_soccontroller_scratch_storage[31:0];
assign builder_csr_bankarray_csrbank0_bus_errors_w = main_soccontroller_bus_errors_status[31:0];
assign main_soccontroller_bus_errors_we = builder_csr_bankarray_csrbank0_bus_errors_we;
...
always @(posedge sys_clk) begin
	...
	{main_tx_tick, main_tx_phase} <= 23'd6597069;
	if (main_tx_enable) begin
		{main_tx_tick, main_tx_phase} <= (main_tx_phase + 23'd6597069);
	end
	...
	if (main_rx_enable) begin
		{main_rx_tick, main_rx_phase} <= (main_rx_phase + 23'd6597069);
	end
	...
	if (builder_csr_bankarray_csrbank0_reset0_re) begin
		main_soccontroller_reset_storage <= builder_csr_bankarray_csrbank0_reset0_r;
	end
	main_soccontroller_reset_re <= builder_csr_bankarray_csrbank0_reset0_re;
	if (builder_csr_bankarray_csrbank0_scratch0_re) begin
		main_soccontroller_scratch_storage[31:0] <= builder_csr_bankarray_csrbank0_scratch0_r;
	end
	main_soccontroller_scratch_re <= builder_csr_bankarray_csrbank0_scratch0_re;
	main_soccontroller_bus_errors_re <= builder_csr_bankarray_csrbank0_bus_errors_re;
...
assign main_ram_dat_r = mem_1[memadr];
