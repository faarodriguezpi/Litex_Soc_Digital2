...
_io = [
    ...
    ("pmodUS_trig", 0, Pins("B13"),  IOStandard("LVCMOS33")),
    ("pmodUS_echo", 0, Pins("F14"),  IOStandard("LVCMOS33")),
...
builder = Builder(soc, output_dir="build", compile_gateware = False, csr_csv="test/csr.csv")
