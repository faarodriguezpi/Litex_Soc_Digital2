...
set_property PACKAGE_PIN U3 [get_ports {pp[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pp[0]}]
##Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
set_property PACKAGE_PIN V1 [get_ports {pp[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pp[1]}]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
set_property PACKAGE_PIN R1 [get_ports {pp[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pp[2]}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
set_property PACKAGE_PIN P5 [get_ports {pp[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pp[3]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
set_property PACKAGE_PIN U1 [get_ports {pp[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pp[4]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
set_property PACKAGE_PIN R2 [get_ports {pp[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pp[5]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {pp[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pp[6]}]
