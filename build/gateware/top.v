//--------------------------------------------------------------------------------
// Auto-generated by Migen (7014bdc) & LiteX (d0c41990) on 2021-04-11 20:14:32
//--------------------------------------------------------------------------------
module top(
...
wire main_uart1_phy_tx_sink_valid;
reg main_uart1_phy_tx_sink_ready = 1'd0;
wire main_uart1_phy_tx_sink_first;
wire main_uart1_phy_tx_sink_last;
wire [7:0] main_uart1_phy_tx_sink_payload_data;
reg [7:0] main_uart1_phy_tx_data = 8'd0;
reg [3:0] main_uart1_phy_tx_count = 4'd0;
reg main_uart1_phy_tx_enable = 1'd0;
reg [31:0] main_uart1_phy_tx_tick = 32'd0;
reg [31:0] main_uart1_phy_tx_phase = 32'd0;
reg main_uart1_phy_rx_source_valid = 1'd0;
wire main_uart1_phy_rx_source_ready;
reg main_uart1_phy_rx_source_first = 1'd0;
reg main_uart1_phy_rx_source_last = 1'd0;
reg [7:0] main_uart1_phy_rx_source_payload_data = 8'd0;
reg [7:0] main_uart1_phy_rx_data = 8'd0;
reg [3:0] main_uart1_phy_rx_count = 4'd0;
reg main_uart1_phy_rx_enable = 1'd0;
reg [31:0] main_uart1_phy_rx_tick = 32'd0;
reg [31:0] main_uart1_phy_rx_phase = 32'd0;
wire main_uart1_phy_rx_rx;
reg main_uart1_phy_rx_rx_d = 1'd0;
...
reg [3:0] main_uart1_phy_tx_count_rs232phytx1_next_value0 = 4'd0;
reg main_uart1_phy_tx_count_rs232phytx1_next_value_ce0 = 1'd0;
reg main_obj_uart1_tx_rs232phytx1_next_value1 = 1'd0;
reg main_obj_uart1_tx_rs232phytx1_next_value_ce1 = 1'd0;
reg [7:0] main_uart1_phy_tx_data_rs232phytx1_next_value2 = 8'd0;
reg main_uart1_phy_tx_data_rs232phytx1_next_value_ce2 = 1'd0;
reg builder_rs232phyrx1_state = 1'd0;
reg builder_rs232phyrx1_next_state = 1'd0;
reg [3:0] main_uart1_phy_rx_count_rs232phyrx1_next_value0 = 4'd0;
reg main_uart1_phy_rx_count_rs232phyrx1_next_value_ce0 = 1'd0;
reg [7:0] main_uart1_phy_rx_data_rs232phyrx1_next_value1 = 8'd0;
reg main_uart1_phy_rx_data_rs232phyrx1_next_value_ce1 = 1'd0;
...
always @(*) begin
	...
	main_basesoc_cpu_interrupt[2] <= main_irq;
end
...
always @(*) begin
	...
	if ((main_mode == 1'd1)) begin
		{user_led15, user_led14, user_led13, user_led12, user_led11, user_led10, user_led9, user_led8, user_led7, user_led6, user_led5, user_led4, user_led3, user_led2, user_led1, user_led0} <= main_storage;
	end else begin
		{user_led15, user_led14, user_led13, user_led12, user_led11, user_led10, user_led9, user_led8, user_led7, user_led6, user_led5, user_led4, user_led3, user_led2, user_led1, user_led0} <= main_chaser;
	end
end
assign main_done = (main_count == 1'd0);
always @(*) begin
	main_uart1_phy_tx_data_rs232phytx1_next_value2 <= 8'd0;
	main_uart1_phy_tx_enable <= 1'd0;
	main_uart1_phy_tx_data_rs232phytx1_next_value_ce2 <= 1'd0;
	builder_rs232phytx1_next_state <= 1'd0;
	main_uart1_phy_tx_count_rs232phytx1_next_value0 <= 4'd0;
	main_uart1_phy_tx_count_rs232phytx1_next_value_ce0 <= 1'd0;
	main_uart1_phy_tx_sink_ready <= 1'd0;
	main_obj_uart1_tx_rs232phytx1_next_value1 <= 1'd0;
	main_obj_uart1_tx_rs232phytx1_next_value_ce1 <= 1'd0;
	builder_rs232phytx1_next_state <= builder_rs232phytx1_state;
	case (builder_rs232phytx1_state)
		1'd1: begin
			main_uart1_phy_tx_enable <= 1'd1;
			if (main_uart1_phy_tx_tick) begin
				main_obj_uart1_tx_rs232phytx1_next_value1 <= main_uart1_phy_tx_data;
				main_obj_uart1_tx_rs232phytx1_next_value_ce1 <= 1'd1;
				main_uart1_phy_tx_count_rs232phytx1_next_value0 <= (main_uart1_phy_tx_count + 1'd1);
				main_uart1_phy_tx_count_rs232phytx1_next_value_ce0 <= 1'd1;
				main_uart1_phy_tx_data_rs232phytx1_next_value2 <= {1'd1, main_uart1_phy_tx_data[7:1]};
				main_uart1_phy_tx_data_rs232phytx1_next_value_ce2 <= 1'd1;
				if ((main_uart1_phy_tx_count == 4'd9)) begin
					main_uart1_phy_tx_sink_ready <= 1'd1;
					builder_rs232phytx1_next_state <= 1'd0;
				end
			end
		end
		default: begin
			main_uart1_phy_tx_count_rs232phytx1_next_value0 <= 1'd0;
			main_uart1_phy_tx_count_rs232phytx1_next_value_ce0 <= 1'd1;
			main_obj_uart1_tx_rs232phytx1_next_value1 <= 1'd1;
			main_obj_uart1_tx_rs232phytx1_next_value_ce1 <= 1'd1;
			if (main_uart1_phy_tx_sink_valid) begin
				main_obj_uart1_tx_rs232phytx1_next_value1 <= 1'd0;
				main_obj_uart1_tx_rs232phytx1_next_value_ce1 <= 1'd1;
				main_uart1_phy_tx_data_rs232phytx1_next_value2 <= main_uart1_phy_tx_sink_payload_data;
				main_uart1_phy_tx_data_rs232phytx1_next_value_ce2 <= 1'd1;
...
always @(*) begin
	main_uart1_phy_rx_source_payload_data <= 8'd0;
	main_uart1_phy_rx_data_rs232phyrx1_next_value1 <= 8'd0;
	main_uart1_phy_rx_data_rs232phyrx1_next_value_ce1 <= 1'd0;
	main_uart1_phy_rx_enable <= 1'd0;
	builder_rs232phyrx1_next_state <= 1'd0;
	main_uart1_phy_rx_count_rs232phyrx1_next_value0 <= 4'd0;
	main_uart1_phy_rx_source_valid <= 1'd0;
	main_uart1_phy_rx_count_rs232phyrx1_next_value_ce0 <= 1'd0;
	builder_rs232phyrx1_next_state <= builder_rs232phyrx1_state;
	case (builder_rs232phyrx1_state)
		1'd1: begin
			main_uart1_phy_rx_enable <= 1'd1;
			if (main_uart1_phy_rx_tick) begin
				main_uart1_phy_rx_count_rs232phyrx1_next_value0 <= (main_uart1_phy_rx_count + 1'd1);
				main_uart1_phy_rx_count_rs232phyrx1_next_value_ce0 <= 1'd1;
				main_uart1_phy_rx_data_rs232phyrx1_next_value1 <= {main_uart1_phy_rx_rx, main_uart1_phy_rx_data[7:1]};
				main_uart1_phy_rx_data_rs232phyrx1_next_value_ce1 <= 1'd1;
				if ((main_uart1_phy_rx_count == 4'd9)) begin
					main_uart1_phy_rx_source_valid <= (main_uart1_phy_rx_rx == 1'd1);
					main_uart1_phy_rx_source_payload_data <= main_uart1_phy_rx_data;
					builder_rs232phyrx1_next_state <= 1'd0;
				end
			end
		end
		default: begin
			main_uart1_phy_rx_count_rs232phyrx1_next_value0 <= 1'd0;
			main_uart1_phy_rx_count_rs232phyrx1_next_value_ce0 <= 1'd1;
			if (((main_uart1_phy_rx_rx == 1'd0) & (main_uart1_phy_rx_rx_d == 1'd1))) begin
				builder_rs232phyrx1_next_state <= 1'd1;
			end
		end
	endcase
end
assign main_uart_sink_valid = main_uart1_phy_rx_source_valid;
assign main_uart1_phy_rx_source_ready = main_uart_sink_ready;
assign main_uart_sink_first = main_uart1_phy_rx_source_first;
assign main_uart_sink_last = main_uart1_phy_rx_source_last;
assign main_uart_sink_payload_data = main_uart1_phy_rx_source_payload_data;
assign main_uart1_phy_tx_sink_valid = main_uart_source_valid;
assign main_uart_source_ready = main_uart1_phy_tx_sink_ready;
assign main_uart1_phy_tx_sink_first = main_uart_source_first;
assign main_uart1_phy_tx_sink_last = main_uart_source_last;
assign main_uart1_phy_tx_sink_payload_data = main_uart_source_payload_data;
...
assign builder_csr_bankarray_csrbank1_sel = (builder_csr_bankarray_interface1_bank_bus_adr[13:9] == 3'd6);
...
assign main_rxtx_r = builder_csr_bankarray_interface4_bank_bus_dat_w[7:0];
always @(*) begin
	main_rxtx_we <= 1'd0;
	main_rxtx_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank4_sel & (builder_csr_bankarray_interface4_bank_bus_adr[8:0] == 1'd0))) begin
		main_rxtx_re <= builder_csr_bankarray_interface4_bank_bus_we;
		main_rxtx_we <= (~builder_csr_bankarray_interface4_bank_bus_we);
	end
end
...
assign builder_csr_bankarray_csrbank4_txfull_w = main_txfull_status;
assign main_txfull_we = builder_csr_bankarray_csrbank4_txfull_we;
assign builder_csr_bankarray_csrbank4_rxempty_w = main_rxempty_status;
assign main_rxempty_we = builder_csr_bankarray_csrbank4_rxempty_we;
always @(*) begin
	main_status_status <= 2'd0;
	main_status_status[0] <= main_tx0;
	main_status_status[1] <= main_rx0;
end
assign builder_csr_bankarray_csrbank4_ev_status_w = main_status_status[1:0];
...
assign builder_csr_bankarray_csrbank4_ev_pending_w = main_pending_status[1:0];
...
assign builder_csr_bankarray_csrbank4_ev_enable0_w = main_enable_storage[1:0];
assign builder_csr_bankarray_csrbank4_txempty_w = main_txempty_status;
assign main_txempty_we = builder_csr_bankarray_csrbank4_txempty_we;
assign builder_csr_bankarray_csrbank4_rxfull_w = main_rxfull_status;
assign main_rxfull_we = builder_csr_bankarray_csrbank4_rxfull_we;
...
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed0 <= main_basesoc_cpu_ibus_adr;
		end
		default: begin
			builder_array_muxed0 <= main_basesoc_cpu_dbus_adr;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed1 <= main_basesoc_cpu_ibus_dat_w;
		end
		default: begin
			builder_array_muxed1 <= main_basesoc_cpu_dbus_dat_w;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed2 <= main_basesoc_cpu_ibus_sel;
		end
		default: begin
			builder_array_muxed2 <= main_basesoc_cpu_dbus_sel;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed3 <= main_basesoc_cpu_ibus_cyc;
		end
		default: begin
			builder_array_muxed3 <= main_basesoc_cpu_dbus_cyc;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed4 <= main_basesoc_cpu_ibus_stb;
		end
		default: begin
			builder_array_muxed4 <= main_basesoc_cpu_dbus_stb;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed5 <= main_basesoc_cpu_ibus_we;
		end
		default: begin
			builder_array_muxed5 <= main_basesoc_cpu_dbus_we;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed6 <= main_basesoc_cpu_ibus_cti;
		end
		default: begin
			builder_array_muxed6 <= main_basesoc_cpu_dbus_cti;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed7 <= main_basesoc_cpu_ibus_bte;
		end
		default: begin
			builder_array_muxed7 <= main_basesoc_cpu_dbus_bte;
		end
	endcase
end
assign main_basesoc_rx_rx = builder_xilinxmultiregimpl0_regs1;
assign main_uart1_phy_rx_rx = builder_xilinxmultiregimpl1_regs1;

always @(posedge por_clk) begin
	main_int_rst <= (~cpu_reset);
end
...
always @(posedge sys_clk) begin
	...
	{main_uart1_phy_tx_tick, main_uart1_phy_tx_phase} <= 19'd412316;
	if (main_uart1_phy_tx_enable) begin
		{main_uart1_phy_tx_tick, main_uart1_phy_tx_phase} <= (main_uart1_phy_tx_phase + 19'd412316);
	end
	builder_rs232phytx1_state <= builder_rs232phytx1_next_state;
	if (main_uart1_phy_tx_count_rs232phytx1_next_value_ce0) begin
		main_uart1_phy_tx_count <= main_uart1_phy_tx_count_rs232phytx1_next_value0;
	end
	if (main_obj_uart1_tx_rs232phytx1_next_value_ce1) begin
		uart1_tx <= main_obj_uart1_tx_rs232phytx1_next_value1;
	end
	if (main_uart1_phy_tx_data_rs232phytx1_next_value_ce2) begin
		main_uart1_phy_tx_data <= main_uart1_phy_tx_data_rs232phytx1_next_value2;
	end
	main_uart1_phy_rx_rx_d <= main_uart1_phy_rx_rx;
	{main_uart1_phy_rx_tick, main_uart1_phy_rx_phase} <= 32'd2147483648;
	if (main_uart1_phy_rx_enable) begin
		{main_uart1_phy_rx_tick, main_uart1_phy_rx_phase} <= (main_uart1_phy_rx_phase + 19'd412316);
	end
	builder_rs232phyrx1_state <= builder_rs232phyrx1_next_state;
	if (main_uart1_phy_rx_count_rs232phyrx1_next_value_ce0) begin
		main_uart1_phy_rx_count <= main_uart1_phy_rx_count_rs232phyrx1_next_value0;
	end
	if (main_uart1_phy_rx_data_rs232phyrx1_next_value_ce1) begin
		main_uart1_phy_rx_data <= main_uart1_phy_rx_data_rs232phyrx1_next_value1;
	end
	...
	if (builder_csr_bankarray_csrbank4_sel) begin
		case (builder_csr_bankarray_interface4_bank_bus_adr[8:0])
			1'd0: begin
				builder_csr_bankarray_interface4_bank_bus_dat_r <= main_rxtx_w;
			end
			1'd1: begin
	...
	main_txfull_re <= builder_csr_bankarray_csrbank4_txfull_re;
	main_rxempty_re <= builder_csr_bankarray_csrbank4_rxempty_re;
	main_status_re <= builder_csr_bankarray_csrbank4_ev_status_re;
	if (builder_csr_bankarray_csrbank4_ev_pending_re) begin
		main_pending_r[1:0] <= builder_csr_bankarray_csrbank4_ev_pending_r;
	end
	main_pending_re <= builder_csr_bankarray_csrbank4_ev_pending_re;
	if (builder_csr_bankarray_csrbank4_ev_enable0_re) begin
		main_enable_storage[1:0] <= builder_csr_bankarray_csrbank4_ev_enable0_r;
	end
	main_enable_re <= builder_csr_bankarray_csrbank4_ev_enable0_re;
	main_txempty_re <= builder_csr_bankarray_csrbank4_txempty_re;
	main_rxfull_re <= builder_csr_bankarray_csrbank4_rxfull_re;
	if (sys_rst) begin
		...
		main_count <= 22'd3125000;
		uart1_tx <= 1'd0;
		main_uart1_phy_tx_tick <= 32'd0;
		main_uart1_phy_tx_phase <= 32'd0;
		main_uart1_phy_rx_tick <= 32'd0;
		main_uart1_phy_rx_phase <= 32'd0;
		main_uart1_phy_rx_rx_d <= 1'd0;
		main_txfull_re <= 1'd0;
...
always @(posedge sys_clk) begin
	if (main_tx_fifo_wrport_we)
		storage_2[main_tx_fifo_wrport_adr] <= main_tx_fifo_wrport_dat_w;
	memdat_5 <= storage_2[main_tx_fifo_wrport_adr];
end

always @(posedge sys_clk) begin
	if (main_tx_fifo_rdport_re)
		memdat_6 <= storage_2[main_tx_fifo_rdport_adr];
end

assign main_tx_fifo_wrport_dat_r = memdat_5;
assign main_tx_fifo_rdport_dat_r = memdat_6;
...
always @(posedge sys_clk) begin
	if (main_rx_fifo_wrport_we)
		storage_3[main_rx_fifo_wrport_adr] <= main_rx_fifo_wrport_dat_w;
	memdat_7 <= storage_3[main_rx_fifo_wrport_adr];
end

always @(posedge sys_clk) begin
	if (main_rx_fifo_rdport_re)
		memdat_8 <= storage_3[main_rx_fifo_rdport_adr];
end

assign main_rx_fifo_wrport_dat_r = memdat_7;
assign main_rx_fifo_rdport_dat_r = memdat_8;
